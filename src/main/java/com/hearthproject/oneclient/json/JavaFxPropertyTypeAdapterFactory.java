...
public class JavaFxPropertyTypeAdapterFactory implements TypeAdapterFactory {
	 ...
	 *
	 * @param throwOnNullProperties if true, this adapter will throw NullPropertyException when given a null {@link Property} to
	 * serialize
	 * @param throwOnNullPrimitives if true, null values in the JSON are not accepted for primitive properties like {@link IntegerProperty}
	 * or {@link BooleanProperty} during deserialization, and cause a NullPrimitiveException to be
	 */
