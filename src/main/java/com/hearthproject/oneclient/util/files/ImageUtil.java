...
public class ImageUtil {
    ...
    public static Image openCachedImage(String file) {
        return openCachedImage(new File(file));
    }
    ...
    public static class ImageOpenService extends Service<Image> {
        private String path;
        private String name;

        public ImageOpenService(String path, String name) {
            this.path = path;
            this.name = name;
        }
        ...
        protected Task<Image> createTask() {
            return new Task<Image>() {
                ...
                protected Image call() throws Exception {
                    return openCachedImage(new File(path), name);
                }
            };
        }
    }

    public static class ImageDownloadService extends Service<Image> {
        public String url, name;

        public ImageDownloadService(String url, String name) {
            this.url = url;
            this.name = name;
