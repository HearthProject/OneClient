...
//Dirty work around to stop me having to make a full forge installer or having to fork one class
...
public class VersionInfo {
	...
	public VersionInfo() {
		//This is using our own input stream so I can give it any profile and it will ingore the one in the jar.
		InputStream installProfile = ForgeUtils.VERSION_PROFILE;
	...
	public static void extractFile(File path) throws IOException {
		//Downloads the forge jar, doesnt extract from the installer
		ForgeUtils.downloadForgeJar(path);
	}
